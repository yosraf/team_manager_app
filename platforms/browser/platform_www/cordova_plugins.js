...
module.exports = [
    ...
    {
        "file": "plugins/cordova-plugin-firebase-config/www/FirebaseConfig.js",
        "id": "cordova-plugin-firebase-config.FirebaseConfig",
        "pluginId": "cordova-plugin-firebase-config",
        "merges": [
            "cordova.plugins.firebase.config"
        ]
    },
    {
...
// TOP OF METADATA
{
    ...
    "cordova-plugin-firebase-config": "4.0.0",
