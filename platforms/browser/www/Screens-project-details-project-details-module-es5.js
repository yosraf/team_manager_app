...
var ProjectDetailsPage = /** @class */ (function () {
    ...
    ProjectDetailsPage.prototype.ngOnInit = function () {
        var _this = this;
        var p = new _Models_Project__WEBPACK_IMPORTED_MODULE_5__["Project"]();
        var t = new _Models_Task__WEBPACK_IMPORTED_MODULE_6__["Task"]();
        ...
        this.service.getTasks(this.id).forEach(function (task) {
            task.forEach(function (task) {
                ...
                _this.service.getClient(t.person).then(function (res) {
                    _this.team.push(res);
                });
            });
        });
