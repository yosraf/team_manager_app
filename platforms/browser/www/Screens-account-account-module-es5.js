...
module.exports = "ion-title {\n  color: #462373; }\n\n.card {\n  margin: 0 auto; }\n\n.card .header {\n    height: 200px; }\n\n.card .header .avatar {\n      width: 130px;\n      height: 130px;\n      position: relative;\n      margin: 0 auto; }\n\n.card .header .avatar img {\n        display: block;\n        border-radius: 50%;\n        position: absolute;\n        bottom: calc(-1*(10px));\n        background-color: #fff; }\n\n.card .header .update {\n      position: relative;\n      margin: 0 auto;\n      display: block;\n      text-align: center;\n      bottom: 3%; }\n\n.card .header .update ion-icon {\n        font-size: 27px;\n        color: #9980FA; }\n\n.card .header .description {\n      bottom: 15%;\n      position: relative; }\n\n.card .header .description h3 {\n        text-align: center;\n        font-weight: bold;\n        color: #462373; }\n\n.card .header .position {\n      bottom: 25%;\n      position: relative; }\n\n.card .header .position h4 {\n        text-align: center;\n        color: #ff7300; }\n\n.card .header .position ion-icon {\n        font-size: 25px;\n        color: #ff7300; }\n\n.card ion-card {\n    box-shadow: none !important; }\n\n.card ion-card ion-icon {\n      color: #ff7300; }\n\n.card ion-card ion-label {\n      color: #462373; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AccountPage = /** @class */ (function () {
    function AccountPage(camera, file, webview, actionSheetController, toastController, plateform, loadingController, ref, filePath, alertCtr, authService, service) {
        this.camera = camera;
        this.file = file;
                    ...
                    case 0: return [4 /*yield*/, this.alertCtr.create({
                            ...
                            buttons: [
                                'Cancel',
                                {
                                    ...
                                    handler: function (d) {
                                        if (type == "email") {
                                            _this.account["email"] = d["email"];
                                            _this.service.updateEmail(d["email"]);
                                        }
                                        else if (type == "password") {
                                            _this.account["password"] = d["password"];
                                            _this.service.updatePassword(d["password"]);
                                        }
                                        else if (type == "phone") {
                                            _this.account["phone"] = d["phone"];
                                            _this.service.updatePhone(d["phone"]);
                                        }
                                    }
                                }
                            ],
...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.updatePhone = function (phone) {
        var value = firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().currentUser.uid;
        this.afs.collection('users').get().forEach(function (doc) {
    ...
    AccountService.prototype.updateImage = function (image) {
    };
