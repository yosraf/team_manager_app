...
let ClientProjectsComponent = class ClientProjectsComponent {
    constructor(route, service, alertConroller, toast) {
        this.route = route;
        this.service = service;
...
let DeveloperHcontentComponent = class DeveloperHcontentComponent {
    constructor(route, service) {
        this.route = route;
        this.service = service;
        this.projects = [];
...
DeveloperHcontentComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let DeveloperHomeContentComponent = class DeveloperHomeContentComponent {
    constructor() { }
    ngOnInit() { }
};
...
let ProjectsComponent = class ProjectsComponent {
    constructor(route, service, afs, toast, alertController) {
        this.route = route;
        this.service = service;
        this.afs = afs;
        this.toast = toast;
    ...
    delete(id) {
        let toast;
        this.presentToast("deleted successfuly").then(res => {
            toast = res;
        });
...
/* harmony import */ var ionic_long_press__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ionic-long-press */ "./node_modules/ionic-long-press/fesm2015/ionic-long-press.js");
...
let TaskDevService = class TaskDevService {
    constructor(afs) {
        this.afs = afs;
        this.ids = [];
    }
