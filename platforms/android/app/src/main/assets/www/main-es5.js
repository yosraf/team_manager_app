...
var map = {
	"./Screens/account/account.module": [
...
var AuthentificationService = /** @class */ (function () {
    function AuthentificationService(afs, fcm, platform) {
        this.afs = afs;
        this.fcm = fcm;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        token = _a.sent();
                        return [4 /*yield*/, this.fcm.hasPermission()];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    AuthentificationService.prototype.registerUser = function (value) {
    ...
    AuthentificationService.prototype.createUser = function (value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    AuthentificationService.prototype.loginUser = function (value) {
        return new Promise(function (resolve, reject) {
...
var FcmService = /** @class */ (function () {
    ...
    FcmService.prototype.sendNotif = function (title, message) {
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, toastController, splashScreen, statusBar, route, fcm, localNotifications) {
        this.platform = platform;
...
/* harmony import */ var _Services_authentification_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Services/authentification.service */ "./src/app/Services/authentification.service.ts");
...
firebase__WEBPACK_IMPORTED_MODULE_15__["initializeApp"](src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].firbase);
...
var environment = {
    production: false,
    firbase: {
        apiKey: "AIzaSyAe1DtJYjpw-tbyW1QblXj5pqvbPUoCdV8",
        authDomain: "gestioncollab.firebaseapp.com",
        databaseURL: "https://gestioncollab.firebaseio.com",
        projectId: "gestioncollab",
        storageBucket: "gestioncollab.appspot.com",
        messagingSenderId: "728240243777",
        appId: "1:728240243777:web:ad581c1a3c1814a98cf2c0",
        measurementId: "G-LYM68MS68C"
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/yosrafatnassi/Bureau/3ing/mobile/team_manager_app/src/main.ts */"./src/main.ts");
