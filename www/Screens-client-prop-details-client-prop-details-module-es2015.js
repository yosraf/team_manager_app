...
let ClientPropDetailsPageModule = class ClientPropDetailsPageModule {
};
...
let ClientPropDetailsPage = class ClientPropDetailsPage {
    constructor(route, router, service, downloader, alertCrtl, loadingController, toast) {
        this.route = route;
        this.router = router;
    ...
    presentAlertPrompt() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let toast = yield this.presentToast();
...
ClientPropDetailsPage.ctorParameters = () => [
...
//# sourceMappingURL=Screens-client-prop-details-client-prop-details-module-es2015.js.map