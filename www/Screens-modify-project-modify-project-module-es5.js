...
var ModifyProjectPageModule = /** @class */ (function () {
    function ModifyProjectPageModule() {
    }
    ...
    return ModifyProjectPageModule;
}());
...
var ModifyProjectPage = /** @class */ (function () {
    function ModifyProjectPage(route, router, service, formBuilder) {
        var _this = this;
        this.route = route;
        this.router = router;
    ...
    ModifyProjectPage.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getProject(this.id).then(function (res) {
            _this.project = res;
            _this.uid = _this.project.client;
            console.log(_this.project.client);
            _this.service.getClient(_this.uid).then(function (cl) {
                _this.owner = cl;
    ...
    ModifyProjectPage.prototype.modify = function (value) {
        var _this = this;
        var client;
    ...
    ModifyProjectPage.prototype.back = function (id) {
        var url = "/task/" + id;
        this.router.navigate([url]);
    };
    ModifyProjectPage.ctorParameters = function () { return [
...
//# sourceMappingURL=Screens-modify-project-modify-project-module-es5.js.map