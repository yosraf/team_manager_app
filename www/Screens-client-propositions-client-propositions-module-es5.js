...
var ClientPropositionsPage = /** @class */ (function () {
    function ClientPropositionsPage(service) {
        ...
        this.service.AsyncPropositions().subscribe(function (data) {
            ...
            data.forEach(function (d) {
                ...
                if (obj['manager'] == value.uid) {
                    var name_1;
                    name_1 = Promise.resolve(_this.service.getClient(obj.client).then(function (res) {
                        console.log(res);
                        return res;
                    }));
                    var p = {
